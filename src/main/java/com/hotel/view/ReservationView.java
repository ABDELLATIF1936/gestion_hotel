...
public class ReservationView extends VBox {
    ...
    private void initializeComponents() {
        ...
        tableView.getColumns().addAll(colId, colClient, colChambre, colDateDebut, colDateFin, colStatut, colNbPersonnes);
    ...
    private void setupLayout() {
        ...
        // Section Services (toujours visible mais désactivée si aucune réservation sélectionnée)
        ...
        // Désactiver les contrôles par défaut (seront activés quand une réservation est sélectionnée)
    ...
    private void deleteReservation() {
        ...
        confirm.setContentText("Êtes-vous sûr de vouloir supprimer la réservation " + selected.getIdReservation() + " ?");
